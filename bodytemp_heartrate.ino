 // Note this code is cited in the citation document attached with this assignment
 // This is a modification of that code
...
LiquidCrystal lcd(7,6,2,3,4,5);  // Volatile Variables. It's also used in interrupt service routine
...
// prints to the serial when a heartbeat occurs
