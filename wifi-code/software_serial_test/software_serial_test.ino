...
SoftwareSerial espSerial =  SoftwareSerial(12,11);   // arduino RX pin=2  arduino TX pin=3    connect the arduino RX pin to esp8266 TX pin   -  connect the arduino TX pin to esp8266 RX pin. 
/*
...
void setup() {
 Serial.begin(9600);
 espSerial.begin(115200);         // Change this value to 9600 or 115200
}
//==============================
void loop() {
